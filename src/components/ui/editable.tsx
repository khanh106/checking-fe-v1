...
const EditableRoot = React.forwardRef<HTMLDivElement, EditableRootProps>((props, forwardedRef) => {
  ...
  return (
    <EditableContext.Provider value={contextValue}>
      ...
      {isFormControl && (
        <VisuallyHiddenInput type="hidden" control={formTrigger} name={name} value={value} disabled={disabled} readOnly={readOnly} required={required} />
      )}
...
const EditablePreview = React.forwardRef<HTMLDivElement, EditablePreviewProps>((props, forwardedRef) => {
  ...
  return (
    <PreviewPrimitive
      ...
      onKeyDown={onKeyDown}
      className={cn(
        "bg-neutral-1 cursor-text truncate rounded px-3 py-2.5 text-sm",
        "focus-visible:ring-ring focus-visible:ring-1 focus-visible:outline-hidden",
        "data-empty:text-neutral-6 data-disabled:cursor-not-allowed data-disabled:opacity-50 data-readonly:cursor-default",
        className,
      )}
    >
...
const EditableInput = React.forwardRef<HTMLInputElement, EditableInputProps>((props, forwardedRef) => {
  ...
  const onKeyDown = React.useCallback(
    ...
    [context.value, context.onSubmit, context.onCancel, context.onEscapeKeyDown, inputProps.onKeyDown, isDisabled, isReadOnly],
  )
  ...
  return (
    <InputPrimitive
      ...
      onKeyDown={onKeyDown}
      className={cn(
        "bg-neutral-1 flex rounded px-3 py-2.5 text-sm shadow-xs transition-colors",
        "file:text-neutral-10 file:border-0 file:bg-transparent file:text-sm file:font-medium",
        "focus-visible:ring-ring focus-visible:ring-1 focus-visible:outline-hidden",
        "placeholder:text-neutral-6 disabled:cursor-not-allowed disabled:opacity-50",
...
const EditableCancel = React.forwardRef<HTMLButtonElement, EditableCancelProps>((props, forwardedRef) => {
  ...
  return <CancelPrimitive type="button" aria-controls={context.id} data-slot="editable-cancel" {...cancelProps} onClick={onClick} ref={forwardedRef} />
})
...
const EditableSubmit = React.forwardRef<HTMLButtonElement, EditableSubmitProps>((props, forwardedRef) => {
  ...
  return <SubmitPrimitive type="button" aria-controls={context.id} data-slot="editable-submit" {...submitProps} ref={forwardedRef} onClick={onClick} />
})
