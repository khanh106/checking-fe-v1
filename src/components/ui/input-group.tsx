...
function InputGroupRoot(props: InputGroupRootProps) {
  const { dir: dirProp, orientation = "horizontal", size = "default", className, asChild, disabled, invalid, required, ...rootProps } = props
...
interface InputGroupItemProps extends React.ComponentProps<"input">, VariantProps<typeof inputGroupItemVariants> {
  asChild?: boolean
}
